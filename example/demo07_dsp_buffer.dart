...
Future<void> main() async {
  ...
  print('Loaded piano.wav: ${buffer.length} samples '
  ...
  drawable.drawLine(start: 24000, stop: 47999, startValue: 0.5, stopValue: -0.5);
  ...
  for (var i = 0; i < burst.length; i++) {
    burst[i] = 0.4 * (i % 2 == 0 ? 1.0 : -1.0); // square at Nyquist/2 — quiet click
  }
  ...
  for (var i = 0; i < 80; i++) { sys.update(); sys.sleep(16); }
