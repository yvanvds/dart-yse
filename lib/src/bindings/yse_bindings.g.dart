...
class YseBindings {
  ...
  ffi.Pointer<YseDspObject> dsp_morphing_reverb_create() {
    return _dsp_morphing_reverb_create();
  }

  late final _dsp_morphing_reverb_createPtr =
      _lookup<ffi.NativeFunction<ffi.Pointer<YseDspObject> Function()>>(
        'yse_dsp_morphing_reverb_create',
      );
  late final _dsp_morphing_reverb_create = _dsp_morphing_reverb_createPtr
      .asFunction<ffi.Pointer<YseDspObject> Function()>();
  ...
  ffi.Pointer<YseDspObject> dsp_patcher_insert_create(
    ffi.Pointer<YsePatcher> patcher,
  ) {
    return _dsp_patcher_insert_create(patcher);
  }

  late final _dsp_patcher_insert_createPtr =
      _lookup<
        ffi.NativeFunction<
          ffi.Pointer<YseDspObject> Function(ffi.Pointer<YsePatcher>)
        >
      >('yse_dsp_patcher_insert_create');
  late final _dsp_patcher_insert_create = _dsp_patcher_insert_createPtr
      .asFunction<
        ffi.Pointer<YseDspObject> Function(ffi.Pointer<YsePatcher>)
      >();
  ...
  void dsp_morphing_reverb_set_preset_a(
    ffi.Pointer<YseDspObject> obj,
    YseReverbPreset preset,
  ) {
    return _dsp_morphing_reverb_set_preset_a(obj, preset.value);
  }

  late final _dsp_morphing_reverb_set_preset_aPtr =
      _lookup<
        ffi.NativeFunction<
          ffi.Void Function(ffi.Pointer<YseDspObject>, ffi.UnsignedInt)
        >
      >('yse_dsp_morphing_reverb_set_preset_a');
  late final _dsp_morphing_reverb_set_preset_a =
      _dsp_morphing_reverb_set_preset_aPtr
          .asFunction<void Function(ffi.Pointer<YseDspObject>, int)>();

  void dsp_morphing_reverb_set_preset_b(
    ffi.Pointer<YseDspObject> obj,
    YseReverbPreset preset,
  ) {
    return _dsp_morphing_reverb_set_preset_b(obj, preset.value);
  }

  late final _dsp_morphing_reverb_set_preset_bPtr =
      _lookup<
        ffi.NativeFunction<
          ffi.Void Function(ffi.Pointer<YseDspObject>, ffi.UnsignedInt)
        >
      >('yse_dsp_morphing_reverb_set_preset_b');
  late final _dsp_morphing_reverb_set_preset_b =
      _dsp_morphing_reverb_set_preset_bPtr
          .asFunction<void Function(ffi.Pointer<YseDspObject>, int)>();

  /// Set an endpoint from a custom parameter set. NULL values is a no-op.
  void dsp_morphing_reverb_set_preset_a_values(
    ffi.Pointer<YseDspObject> obj,
    ffi.Pointer<YseReverbPresetValues> values,
  ) {
    return _dsp_morphing_reverb_set_preset_a_values(obj, values);
  }

  late final _dsp_morphing_reverb_set_preset_a_valuesPtr =
      _lookup<
        ffi.NativeFunction<
          ffi.Void Function(
            ffi.Pointer<YseDspObject>,
            ffi.Pointer<YseReverbPresetValues>,
          )
        >
      >('yse_dsp_morphing_reverb_set_preset_a_values');
  late final _dsp_morphing_reverb_set_preset_a_values =
      _dsp_morphing_reverb_set_preset_a_valuesPtr
          .asFunction<
            void Function(
              ffi.Pointer<YseDspObject>,
              ffi.Pointer<YseReverbPresetValues>,
  ...
  void dsp_morphing_reverb_set_preset_b_values(
    ffi.Pointer<YseDspObject> obj,
    ffi.Pointer<YseReverbPresetValues> values,
  ) {
    return _dsp_morphing_reverb_set_preset_b_values(obj, values);
  }

  late final _dsp_morphing_reverb_set_preset_b_valuesPtr =
      _lookup<
        ffi.NativeFunction<
          ffi.Void Function(
            ffi.Pointer<YseDspObject>,
        ...
        >
      >('yse_dsp_morphing_reverb_set_preset_b_values');
  late final _dsp_morphing_reverb_set_preset_b_values =
      _dsp_morphing_reverb_set_preset_b_valuesPtr
          .asFunction<
            void Function(
              ffi.Pointer<YseDspObject>,
              ffi.Pointer<YseReverbPresetValues>,
  ...
  void dsp_morphing_reverb_get_preset_a(
    ffi.Pointer<YseDspObject> obj,
    ffi.Pointer<YseReverbPresetValues> out,
  ) {
    return _dsp_morphing_reverb_get_preset_a(obj, out);
  }

  late final _dsp_morphing_reverb_get_preset_aPtr =
      _lookup<
        ffi.NativeFunction<
          ffi.Void Function(
            ffi.Pointer<YseDspObject>,
        ...
        >
      >('yse_dsp_morphing_reverb_get_preset_a');
  late final _dsp_morphing_reverb_get_preset_a =
      _dsp_morphing_reverb_get_preset_aPtr
          .asFunction<
            void Function(
              ffi.Pointer<YseDspObject>,
              ffi.Pointer<YseReverbPresetValues>,
  ...
  void dsp_morphing_reverb_get_preset_b(
    ffi.Pointer<YseDspObject> obj,
    ffi.Pointer<YseReverbPresetValues> out,
  ) {
    return _dsp_morphing_reverb_get_preset_b(obj, out);
  }

  late final _dsp_morphing_reverb_get_preset_bPtr =
      _lookup<
        ffi.NativeFunction<
          ffi.Void Function(
            ffi.Pointer<YseDspObject>,
        ...
        >
      >('yse_dsp_morphing_reverb_get_preset_b');
  late final _dsp_morphing_reverb_get_preset_b =
      _dsp_morphing_reverb_get_preset_bPtr
          .asFunction<
            void Function(
              ffi.Pointer<YseDspObject>,
              ffi.Pointer<YseReverbPresetValues>,
  ...
  void dsp_morphing_reverb_set_morph(
    ffi.Pointer<YseDspObject> obj,
    double value,
  ) {
    return _dsp_morphing_reverb_set_morph(obj, value);
  }

  late final _dsp_morphing_reverb_set_morphPtr =
      _lookup<
        ffi.NativeFunction<
          ffi.Void Function(ffi.Pointer<YseDspObject>, ffi.Float)
        >
      >('yse_dsp_morphing_reverb_set_morph');
  late final _dsp_morphing_reverb_set_morph = _dsp_morphing_reverb_set_morphPtr
      .asFunction<void Function(ffi.Pointer<YseDspObject>, double)>();

  double dsp_morphing_reverb_get_morph(ffi.Pointer<YseDspObject> obj) {
    return _dsp_morphing_reverb_get_morph(obj);
  }

  late final _dsp_morphing_reverb_get_morphPtr =
      _lookup<
        ffi.NativeFunction<ffi.Float Function(ffi.Pointer<YseDspObject>)>
      >('yse_dsp_morphing_reverb_get_morph');
  late final _dsp_morphing_reverb_get_morph = _dsp_morphing_reverb_get_morphPtr
      .asFunction<double Function(ffi.Pointer<YseDspObject>)>();
  ...
  void midi_file_connect_synth(
    ffi.Pointer<YseMidiFile> f,
    ffi.Pointer<YseSynth> synth,
  ) {
    return _midi_file_connect_synth(f, synth);
  }

  late final _midi_file_connect_synthPtr =
      _lookup<
        ffi.NativeFunction<
          ffi.Void Function(ffi.Pointer<YseMidiFile>, ffi.Pointer<YseSynth>)
        >
      >('yse_midi_file_connect_synth');
  late final _midi_file_connect_synth = _midi_file_connect_synthPtr
      .asFunction<
        void Function(ffi.Pointer<YseMidiFile>, ffi.Pointer<YseSynth>)
      >();

  /// Stop routing this file's playback into `synth` (issue #372). Safe to call for
  /// a synth that was never connected.
  void midi_file_disconnect_synth(
    ffi.Pointer<YseMidiFile> f,
    ffi.Pointer<YseSynth> synth,
  ) {
    return _midi_file_disconnect_synth(f, synth);
  }

  late final _midi_file_disconnect_synthPtr =
      _lookup<
        ffi.NativeFunction<
          ffi.Void Function(ffi.Pointer<YseMidiFile>, ffi.Pointer<YseSynth>)
        >
      >('yse_midi_file_disconnect_synth');
  late final _midi_file_disconnect_synth = _midi_file_disconnect_synthPtr
      .asFunction<
        void Function(ffi.Pointer<YseMidiFile>, ffi.Pointer<YseSynth>)
      >();
  ...
  void midi_in_connect_synth(
    ffi.Pointer<YseMidiIn> m,
    ffi.Pointer<YseSynth> synth,
    int channel_filter,
  ) {
    return _midi_in_connect_synth(m, synth, channel_filter);
  }

  late final _midi_in_connect_synthPtr =
      _lookup<
        ffi.NativeFunction<
          ffi.Void Function(
            ffi.Pointer<YseMidiIn>,
  ...
  late final _midi_in_connect_synth = _midi_in_connect_synthPtr
      .asFunction<
        void Function(ffi.Pointer<YseMidiIn>, ffi.Pointer<YseSynth>, int)
      >();

  /// Stop routing incoming device MIDI into `synth` (issue #155). Safe to call for
  /// a synth that was never connected.
  void midi_in_disconnect_synth(
    ffi.Pointer<YseMidiIn> m,
    ffi.Pointer<YseSynth> synth,
  ) {
    return _midi_in_disconnect_synth(m, synth);
  }

  late final _midi_in_disconnect_synthPtr =
      _lookup<
        ffi.NativeFunction<
          ffi.Void Function(ffi.Pointer<YseMidiIn>, ffi.Pointer<YseSynth>)
        >
      >('yse_midi_in_disconnect_synth');
  late final _midi_in_disconnect_synth = _midi_in_disconnect_synthPtr
      .asFunction<
        void Function(ffi.Pointer<YseMidiIn>, ffi.Pointer<YseSynth>)
      >();
...
final class YseReverbPresetValues extends ffi.Struct {
  /// simulated room size, [0, 1]
  @ffi.Float()
  ...
  /// unprocessed level, [0, 1]
  @ffi.Float()
  external double dry;

  /// reverberated level, [0, 1]
  @ffi.Float()
  external double wet;

  /// tail modulation rate, Hz (0 = off)
  @ffi.Float()
  external double mod_frequency;

  /// tail modulation depth (0 = off)
  @ffi.Float()
  external double mod_width;

  /// early reflection delays, samples, [0, 2999]
  @ffi.Array.multi([4])
  external ffi.Array<ffi.Float> early_time;

  /// early reflection gains, [0, 1]
  @ffi.Array.multi([4])
  external ffi.Array<ffi.Float> early_gain;
}
